//! Domain policy for PickupLocation aggregate
//!
...
/// Domain policy for PickupLocation — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<PickupLocation>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type PickupLocationDomainPolicy = PermitAllPolicy<PickupLocation>;
