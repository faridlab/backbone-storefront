//! Domain policy for ProductListing aggregate
//!
...
/// Domain policy for ProductListing — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<ProductListing>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type ProductListingDomainPolicy = PermitAllPolicy<ProductListing>;
