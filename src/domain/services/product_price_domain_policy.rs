//! Domain policy for ProductPrice aggregate
//!
...
/// Domain policy for ProductPrice — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<ProductPrice>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type ProductPriceDomainPolicy = PermitAllPolicy<ProductPrice>;
