//! Domain policy for ShopperParty aggregate
//!
...
/// Domain policy for ShopperParty — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<ShopperParty>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type ShopperPartyDomainPolicy = PermitAllPolicy<ShopperParty>;
