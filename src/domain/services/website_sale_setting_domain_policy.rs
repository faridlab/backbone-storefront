//! Domain policy for WebsiteSaleSetting aggregate
//!
...
/// Domain policy for WebsiteSaleSetting — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<WebsiteSaleSetting>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type WebsiteSaleSettingDomainPolicy = PermitAllPolicy<WebsiteSaleSetting>;
