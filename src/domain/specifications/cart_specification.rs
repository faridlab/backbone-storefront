//! Specifications for Cart aggregate
//!
...
// Each predicate implements `Specification<Cart>` and can be combined
...
//
// pub struct ActiveCartSpec;
// impl Specification<Cart> for ActiveCartSpec {
//     fn is_satisfied_by(&self, e: &Cart) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
