//! Specifications for ProductPrice aggregate
//!
...
// Each predicate implements `Specification<ProductPrice>` and can be combined
...
//
// pub struct ActiveProductPriceSpec;
// impl Specification<ProductPrice> for ActiveProductPriceSpec {
//     fn is_satisfied_by(&self, e: &ProductPrice) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
